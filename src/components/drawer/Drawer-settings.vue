  ...
  <div class="Container">
    ...
    <div class="Setting-wrapper">
      ...
      <div
        ...
        :class="settings.alwaysOnTop ? 'is-active' : 'is-inactive'"
      ></div>
    </div>
    <transition name="slide-left" mode="in-out">
      <div class="Setting-wrapper" v-show="settings.alwaysOnTop">
        <p class="Setting-title">Deactivate Always On Top on Breaks</p>
        <div
          class="Checkbox"
          @click="toggleSetting('breakAlwaysOnTop')"
          :class="settings.breakAlwaysOnTop ? 'is-active' : 'is-inactive'"
    ...
    <div class="Setting-wrapper">
      ...
      <div
        class="Checkbox"
        @click="toggleSetting('autoStartWorkTimer')"
        :class="settings.autoStartWorkTimer ? 'is-active' : 'is-inactive'"
      ></div>
    </div>
    <div class="Setting-wrapper">
      ...
      <div
        class="Checkbox"
        @click="toggleSetting('autoStartBreakTimer')"
        :class="settings.autoStartBreakTimer ? 'is-active' : 'is-inactive'"
      ></div>
    </div>
    <div class="Setting-wrapper">
      ...
      <div
        class="Checkbox"
        @click="toggleTimerSetting('tickSounds')"
        :class="timerSettings.tickSounds ? 'is-active' : 'is-inactive'"
      ></div>
    </div>
    <div class="Setting-wrapper">
      ...
      <div
        class="Checkbox"
        @click="toggleTimerSetting('tickSoundsDuringBreak')"
        :class="
          timerSettings.tickSoundsDuringBreak ? 'is-active' : 'is-inactive'
        "
      ></div>
    </div>
    <div class="Setting-wrapper">
      ...
      <div
        ...
        :class="settings.notifications ? 'is-active' : 'is-inactive'"
      ></div>
    </div>
    <div class="Setting-wrapper">
      ...
      <div
        class="Checkbox"
        @click="toggleSetting('minToTray')"
        :class="settings.minToTray ? 'is-active' : 'is-inactive'"
      ></div>
    </div>
    <div class="Setting-wrapper">
      ...
      <div
        class="Checkbox"
        @click="toggleSetting('minToTrayOnClose')"
        :class="settings.minToTrayOnClose ? 'is-active' : 'is-inactive'"
      ></div>
    </div>
    ...
    <div class="Setting-wrapper">
      ...
      <shortcut-input
        :value="globalShortcut.callTimerToggle"
        @input="(shortcut:string) => setGlobalShortcut('callTimerToggle', shortcut)"
      />
    </div>
    <div class="Setting-wrapper">
      <p class="Setting-title">Reset Timer</p>
      <shortcut-input
        :value="globalShortcut.callTimerReset"
        @input="(shortcut:string) => setGlobalShortcut('callTimerReset', shortcut)"
      />
    </div>
    <div class="Setting-wrapper">
      <p class="Setting-title">Skip Round</p>
      <shortcut-input
        :value="globalShortcut.callTimerSkip"
        @input="(shortcut:string) => setGlobalShortcut('callTimerSkip', shortcut)"
      />
    </div>
  </div>
</template>
...
import { useViewStore, useTimerStore } from "@/store";
import { storeToRefs } from "pinia";

const { settings } = storeToRefs(useViewStore());
const { timerSettings, globalShortcut } = storeToRefs(useTimerStore());

const { toggleSetting } = useViewStore();
const { toggleTimerSetting, setGlobalShortcut } = useTimerStore();
</script>
